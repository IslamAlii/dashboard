...
# --- Country ---
st.subheader("🌍 Retention Forecast - Country Distribution")
if show_percentage:
...
# --- Grade & Module ---
st.subheader("🎓 Retention Forecast - Grade with Module Distribution")
if show_percentage:
...
# --- Churned Revenue ---
st.subheader("💸 Churned Users AOV projection")
if show_percentage:
